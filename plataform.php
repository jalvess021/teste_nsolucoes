...
<body class='body-plataform'>
    <div class="container text-center">
        ...
        <div class="div-search">
                <a href="\teste_nsolucoes/?page=plataform&action=add" class="btn btn-dark btn-lg" id='newUser'><i class="bi bi-person-plus-fill"></i></a>
                <form action='?page=plataform' method='post' class="d-flex" role="search">
                    <input class="form-control form-control-lg me-2" list="datalistOptions" type="search" placeholder="Usuários" aria-label="Search" name='filter-user' id='user-input'>
                    ...
                    <button class="btn btn-outline-dark" id='search-user' type="submit"><i class="bi bi-search"></i></button>
                </form>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover table-sm">
                        <thead>
                            ...
                            <th scope="col">Id</th>
                            <th scope="col" class="d-none d-xxl-table-cell">Nome</th>
                            <th scope="col">Usuário</th>
                            <th scope="col" class="d-none d-md-table-cell">E-mail</th>
                            <th scope="col" class="d-none d-xl-table-cell">Telefone</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="d-none d-xxl-table-cell"><?= $info['nome']?></td>
                                <td><?= $info['usuario']?></td>
                                <td class="d-none d-md-table-cell"><?= $info['email']?></td>
                                <td class="d-none d-xl-table-cell"><?= $info['telefone']?></td>
                                <td class="d-none d-xl-table-cell"><?= $info['status_usu']?></td>
...
<script>
    $("#search-user").click((e)=>{
        if ($("#user-input").val() == "") {
            e.preventDefault();
            window.location = "\\teste_nsolucoes/?page=plataform";
        }
    })
</script>
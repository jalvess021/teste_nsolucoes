        ...
        <div class='row mt-3'>
            ...
            <div class='col-4'>
                <div class='input-group mb-3'>
                    <input type='text' autocomplete='off' name='cpf' id='cpf' class='form-control is-valid' placeholder='xxx.xxx.xxx-xx' aria-label='Recipient's username' aria-describedby='basic-on2' value='".$fetch['cpf']."' required disabled>
                    <span class='input-group-text' id='basic-on2'>CPF</span>
                </div>
            </div>
            <div class='col-4'>
                <div class='input-group mb-3'>
                    <input type='text' autocomplete='off' name='cep' class='form-control is-valid' placeholder='xxxxx-xxx' aria-label='Recipient's username' aria-describedby='basic-on2' id='cep' value='".$fetch['cep']."' required>
        ...
        <div class='row mt-3'>
            ...
            <div class='col-4'>
                    <div class='input-group input-group-sm mb-3'>
                        <input type='text' name='num' value='".$fetch['num_localidade']."' id='locNumber' class='form-control is-valid' aria-label='Recipient's username' aria-describedby='basic-on2' autocomplete='off'  required>
